...
#property indicator_color1  C'239,83,80', C'38,166,154'
...
//--- index buffer
   ...
   SetIndexBuffer(2, ExtADbuffer, INDICATOR_CALCULATIONS);
//--- indicator short name
   IndicatorSetString(INDICATOR_SHORTNAME, "A/D%("+string(ExtPeriod)+")" );
//--- indicator digits
      ...
      if(ExtPeriod > 0 && ExtPeriod <= i + 1)
        {
         ...
         ExtColorBuffer[i] = (total_ad > 0 ? 1 : 0);
        }
     }
