...
//--- indicator buffers
   ...
   SetIndexBuffer(3,ExtADXRBuffer);
//--- calculation buffers
   SetIndexBuffer(4,ExtATRBuffer,INDICATOR_CALCULATIONS);
   SetIndexBuffer(5,ExtPDBuffer,INDICATOR_CALCULATIONS);
   SetIndexBuffer(6,ExtNDBuffer,INDICATOR_CALCULATIONS);
   SetIndexBuffer(7,ExtDXBuffer,INDICATOR_CALCULATIONS);
   SetIndexBuffer(8,ExtTRBuffer,INDICATOR_CALCULATIONS);
   SetIndexBuffer(9,ExtPDSBuffer,INDICATOR_CALCULATIONS);
   SetIndexBuffer(10,ExtNDSBuffer,INDICATOR_CALCULATIONS);
//--- set draw begin
   ...
   PlotIndexSetInteger(3,PLOT_DRAW_BEGIN,ExtADXWPeriod+1);
...
//--- setup indicator level
   ...
   IndicatorSetInteger(INDICATOR_LEVELCOLOR, 1, clrWhiteSmoke);
   ...
   for(int i=start; i<rates_total && !IsStopped(); i++)
     {
      ...
      ExtADXRBuffer[i] = (i >= ExtADXWPeriod ? (ExtADXWBuffer[i] + ExtADXWBuffer[i - ExtADXWPeriod]) / 2 : 0);
     }
